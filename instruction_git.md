...
Для разрешения конфликта нужно в ручную выбрать нужный вам формат:
+ либо принять все изменения
+ либо оставить исходные данные
+ либо принять новые входящте данные
